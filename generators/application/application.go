...
func Generate(bootOpts util.BootstrapOpts) {
	util.GenerateAndSave("", "web/app/dist/.gitkeep", "Front-end production files must compile or be placed here. Delete this file when done.", true)
	util.GenerateAndSave("", "web/app/src/services/.gitkeep", "Generated client code will be here.", true)
	...
	util.GenerateAndSave("", "assets/web/app/.gitkeep", "Place web assets in this folder.", true)
