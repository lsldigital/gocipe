...
func init() {
	...
	fileb := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1527146516, 0),
	...
	filej := &embedded.EmbeddedFile{
		...
		FileModTime: time.Unix(1527098972, 0),
